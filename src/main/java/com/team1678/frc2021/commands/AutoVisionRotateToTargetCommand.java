...
public class AutoVisionRotateToTargetCommand extends CommandBase {
    ...
    public AutoVisionRotateToTargetCommand(Swerve drivetrain, Limelight limelight) {
    ...
    public void execute() {
        ...
        Translation2d translationalVelocity = new Translation2d(0.0, 0.0);
