...
public class WaitForTrajectoryDirectionAction implements Action{
    ...
    public boolean isFinished() {
        // double direction = swerve.getLastTrajectoryVector().direction().getDegrees(); // TODO: Fix
        return true; /*lowerBound.getDegrees() <= direction && direction <= upperBound.getDegrees();*/ // TODO: Fix
    }
