...
public class GoalTracker {
    ...
    public static class TrackReport {
        ...
        public RigidTransform2 field_to_target;
    ...
    public synchronized void update(double timestamp, List<RigidTransform2> field_to_goals) {
        // Try to update existing tracks
        for (RigidTransform2 target : field_to_goals) {
